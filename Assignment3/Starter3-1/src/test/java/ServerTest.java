...
public class ServerTest {
    ...
    // Establishing a connection to the server, make sure 
    // you start the server on localhost and 8888
    @org.junit.Before
    public void setUp() throws Exception {
        sock = new Socket("localhost", 8888); // connect to server
    ...
    @Test
    public void inventoryViewRequest() throws IOException {
